...
saveas(gcf,'../../data/graph/opt_a02_ind_Q1','svg');
...
saveas(gcf,'../../data/graph/opt_a02_ind_R1','svg');
...
saveas(gcf,'../../data/graph/opt_a02_ind_L1','svg');




delete(f)
save('../../data/opt_A02_ind.mat')%Save all the Variables in the Workspace
