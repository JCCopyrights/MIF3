...
% X = square_restricted_incremental_layer_spiral(N,A,L,d,layers,h,x0,y0,z0,phix,phiy,phiz,view)
%
...
%% Code	
function X = square_restricted_incremental_layer_spiral(N,A,L,A0,L0,d,h,x0,y0,z0,phix,phiy,phiz,view)
	...
	Nremainding=N;
	Nmax=floor(min(A/2-A0/2,L/2-L0/2)/d);
	i=1;
	while Nremainding>0
		if Nremainding>Nmax
			Nlayer(i)=Nmax;
...
%% Geometry
% 
% <<..\..\doc\functions\res\square_restricted_incremental_layer_spiral.PNG>>
% 
